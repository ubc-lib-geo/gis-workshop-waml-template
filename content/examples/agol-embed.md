...
ArcGIS Online doesn't always provide embed code for Web Apps, but no matter! Just use the same embed code from above but replace everything after `src=` with the url for the Web App:
